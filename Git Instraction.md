...
```
При слиянии может возникнуть конфлинт интересов, клгда содержание в двух версиях отличается и программа не может сама выбрать что важнее. На экране подсветятся два варианта из обеих версий и программа будет предлагать:
...
__Не забываем созранить изменения после слияния!__
